...
# curl https://raw.githubusercontent.com/hotcoinblockchain/shells/main/update/nginx_add_proxy_config.sh| bash -s https\\:\\/\\/wallet.cypress.klaytn.net:8651 10082 klay
